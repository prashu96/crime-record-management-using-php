...
<tr height="70px">
<td width="80%"></td>
<td width="10%"><a href="authority.php"><img src="images/h.png" height="70px" width="100%"></a></td>
...
<?php
	...
	{
		$q="select * from req r,files f where r.fid=f.fid and ar!=1";
...
if(isset($_REQUEST['grant']))
{
	...
	{
		$q="update req set aotp=$rn,ar=1 where fid=$id and email='$email'";
		$result=mysqli_query($con,$q);
