...
<br><br>
Enter ID of Employee To be Upddated<br><br>
<input type="text" name="id" placeholder="ID" width="200px" height="50px"><br><br>
<input type="submit" name="update" value="Update" width="100px" ="20px"  style="border-radius:30px; width:100px; height:30px; background-color:blue;font:white">
</td>
</tr>
</table>
