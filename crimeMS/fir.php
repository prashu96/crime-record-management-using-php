	  ...
	  <center><h2>FIR Information</h2>
		<table id="customers">
			...
			<?php if($result->num_rows>0)
			{
				...
				{
					echo "Sorry, No FIR info were found";
				}
				?>
			
			
		</table>
		            <center><a href="addfir.php" class="btn btn-warning btn_sm">Add FIR Info</a></center>
